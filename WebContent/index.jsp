...
<body>
	...
	<button class="btn btn-primary" name="add-btn">추가</button>
	<ul class="main-list">
		<li>리스트1
			<button name="del-btn">삭제22</button>
		</li>

		<li>리스트2
			<button name="del-btn">삭제</button>
		</li>
		<li>리스트3
			<button name="del-btn">삭제</button>
		</li>
							...
							if ($.trim($todoInput.val()) == '') {
								...
								$('.main-list')
										.prepend(
												'<li>'
														+ $todoInput.val()
														+ '<button class="btn btn-danger" onclick="deleteBtnClicked(this)"> 삭제 </button> </li>');
								$todoInput.val('');
							}
						});
